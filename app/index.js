...
var materialOrcaGenerator = generators.Base.extend({
    ...
    welcome: function() {
        this.log(yosay(
            'Welcome to the Material Orca AngularJS generator!'
        ));
    },
    ...
    prompting: function () {
        ...
        this.prompt(prompts, function (answers) {
            ...
            this.appName = this.appName || 'material-orca'; //path.basename(process.cwd());
            done();
        }.bind(this));
    },

    displayName: function() {
        this.log('Creating ' + this.appName + ' app based on material-orca.');
    },
